...
$('#prompt-custom-toggle').onchange = () => { document.querySelectorAll('.prompt-user-scene-section').forEach(section => { section.hidden = !$('#prompt-custom-toggle')?.checked }) }
