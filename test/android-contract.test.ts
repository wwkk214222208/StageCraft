...
test('Android media and PNG import remain native, bounded, authenticated, and packaged reproducibly', () => {
  ...
  assert.match(appGradle, /include\("index\.html", "styles\.css", "renderer\.js", "embedded-core\.js", "embedded-core\.json", "version\.json", "core-host\.html", "\*\.json", "prompts\/\*\*", "stories\/\*\*", "web\/\*\*"\)/)
  assert.match(appGradle, /根级 JSON 资产.*必须随 APK 打包/s)
